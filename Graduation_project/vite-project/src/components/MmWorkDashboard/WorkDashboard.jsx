...
import WorkForm from '../MmWorkForm/WorkForm';
import WorkTable from '../../components/MmWorkTable/WorkTable';
...
const initialProjects = [
    {
        ...
        urlWeb: "htttps:/www.chicboutique.com",
    ...
    },
    {
        ...
        webName: "HungryBites",
        urlWeb: "htttps:/www.hungrybites.com",
    ...
    },
    {
        ...
        urlWeb: "htttps:/www.eventmasters.com",
    ...
    },
    {
        ...
        urlWeb: "htttps:/www.protechsolutions.com",
        description: "HungryBites approached us to create a mobile app that streamlined their food delivery service. The app included features like real-time order tracking, easy menu customization, and secure payment options, resulting in improved customer convenience and operational efficiency."
    },
    {
        id: 5,
        ...
        urlWeb: "htttps:/www.dreamhomesrealty.com",
    ...
    },
    {
        ...
        urlWeb: "htttps:/www.fitlifetracker.com",
    ...
    },
    {
        ...
        urlWeb: "htttps:/www.globallogisticssolutions.com",
    ...
    },
    {
        ...
        webName: "EduConnect",
        urlWeb: "htttps:/www.educonnect.com",
    ...
    },
    {
        ...
        webName: "WanderWise",
        urlWeb: "htttps:/www.wanderwise.com",
    ...
    },
    {
        ...
        webName: "ConnectCRM",
        urlWeb: "htttps:/www.connectcrm.com",
...
//             <h2>Our Work CRUD</h2>
//             <WorkTable items={items} onEdit={handleEdit} onDelete={handleDelete} />
//             <WorkForm
//                 items={items}
//                 setItems={setItems}
//                 editItem={editItem}
...
const WorkDashboard = () => {
    const [items, setItems] = useState(() => {
        ...
        if (stored) {
            ...
            // إذا لم يكن هناك بيانات في Local Storage → نستخدم البيانات الأولية
